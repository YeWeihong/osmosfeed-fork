...
2026年3月17日：使文章详情显示抓取到的文章全文，优先显示订阅链接中的<ns0:ecoded>或者<content:encoded>，fallback才是显示<description>，但是还不能显示图片。后续我想实现能不能在详情页渲染文字和图片。忧虑的点在于，可能会对网页的性能影响很大，毕竟有很多文字和图片要加载。

2026年3月16日：fork了这个项目，以便于自己能够进行自定义
